...
const helloWorldExample :Workerd.Config = (
  ...
  services = [
    ...
    (name = "fetcher", worker = .fetcher),
    (name = "cache", worker = .cacher),
    # (name = "cache", external = "localhost:3000"),
    (name = "kv_impl", worker = .kv),
  ],
...
const helloWorld :Workerd.Worker = (
  ...
  bindings = [
    (name = "KV_NS", kvNamespace = "kv_impl"),
  ],
...
const kv :Workerd.Worker = (
  modules = [
    (name = "worker", esModule = embed "kv.js")
  ],
  compatibilityDate = "2023-02-28",
);

const cacher :Workerd.Worker = (
  modules = [
    (name = "worker", esModule = embed "cache.js")
  ],
  compatibilityDate = "2023-02-28",
  compatibilityFlags = [ "nodejs_compat" ],
);

const fetcher :Workerd.Worker = (
  modules = [
